  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 pt-[70px] pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 pt-4 pb-6">
        {/* 🔥 İŞTE BURAYI DÜZELTTİK: href="/" yaptık, artık hata vermeden anasayfaya dönecek */}
        <Link href="/" className="group inline-flex items-center gap-2 text-slate-400 hover:text-indigo-400 transition-all font-bold text-sm uppercase tracking-widest">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-gradient-to-tr from-slate-950 via-[#0a1120] to-indigo-950/30 aspect-square rounded-[2rem] flex items-center justify-center relative border border-slate-800/60 shadow-[0_0_40px_-15px_rgba(99,102,241,0.2)] group overflow-hidden">
            ...
            {mainImage ? (
              <img 
                ...
                src={mainImage} 
                alt={product.name} 
                className="w-[85%] h-[85%] object-scale-down relative z-10 drop-shadow-[0_25px_35px_rgba(0,0,0,0.6)] animate-in fade-in zoom-in-95 duration-500 group-hover:scale-110 group-hover:-translate-y-2 transition-all" 
              />
            ) : (
            ...
            <div className="grid grid-cols-4 gap-3">
              {allImages.map((img, index) => (
                ...
                >
                  ...
                  <img 
                    src={img} 
                    className="w-[80%] h-[80%] object-scale-down relative z-10 drop-shadow-[0_10px_15px_rgba(0,0,0,0.5)]" 
